...
def return_hmdb51(data_dir):
    filename_categories = ospj(data_dir, 'labels', 'classInd.txt')
    root_data = data_dir + "/jpg"
    filename_imglist_train = ospj(data_dir, 'file_list/hmdb51_rgb_train_split_1.txt')
    filename_imglist_val = ospj(data_dir, 'file_list/hmdb51_rgb_val_split_1.txt')
    prefix = 'img_{:05d}.jpg'
...
def return_ucf101(data_dir):
    filename_categories = ospj(data_dir, 'labels', 'classInd.txt')
    root_data = data_dir + "/jpg"
    filename_imglist_train = ospj(data_dir, 'file_list/ucf101_rgb_train_split_1.txt')
    filename_imglist_val = ospj(data_dir, 'file_list/ucf101_rgb_val_split_1.txt')
    prefix = 'img_{:05d}.jpg'
...
def return_dataset(dataset, data_dir):
    dict_single = {'actnet': return_actnet, 'fcvid': return_fcvid, 'minik': return_minik, 'hmdb': return_hmdb51, 'ucf101': return_ucf101}
