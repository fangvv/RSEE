...
# TODO RSEE
parser.add_argument('--irte', action='store_true', help='use RSEE')
parser.add_argument('--irte_joint', action='store_true', help='train RSEE and policy')
parser.add_argument('--blstm', action='store_true', help="use BLSTM for temporal exiting")
parser.add_argument('--blstm_hidden_dim', type=int, default=512, help='hidden_dim for blstm')
parser.add_argument('--irte_final', action='store_true', help='final version of RSEE')
parser.add_argument('--exit_loss', action='store_true', help='use exit loss')
parser.add_argument('--exit_w', type=float, default=0.7, help='exit weight')
parser.add_argument('--frm', type=str, default='none', help='feature reuse module')
parser.add_argument('--online_train', action='store_true', help='whether online train')
parser.add_argument('--load_imagenet', action='store_true', help='load imagenet pretrained weights')
parser.add_argument('--multi_blstm', action='store_true', help='prepare a blstm for every reso')
parser.add_argument('--fake_r', action='store_true', help='use fake r_all to all choose 224')
parser.add_argument('--kd', action='store_true', help='use kd')
parser.add_argument('--stan_lstm', action='store_true', help='use stan lstm')
parser.add_argument('--baseline', action='store_true', help='train baseline')
parser.add_argument('--TE', type=float, default=0.9, help='temporal exit threshold')
parser.add_argument('--vanilla', action='store_true', help='use vanilla backbone')
