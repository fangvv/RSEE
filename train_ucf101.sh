...
#     --epochs 50 \
#     --batch-size 8 \
#     --exp_header bk_ucf101_parallel_res50_t16_epo50_multiReso_lr.001 \
...
# python -u main_base.py hmdb RGB \
#     --irte_joint \
#     --arch parallel_resnet50 --num_segments 16 --lr 0.001 --epochs 50 --batch-size 4 -j 32 \
#     --npb --gpus 0 --exp_header hmdb_pres50_t16_3m124_a.95e.05_ed5_ft15ds_lr.001_gu3_ep50 \
#     --ada_reso_skip --policy_backbone mobilenet_v2 --reso_list 224 168 112 84 \
#     --backbone_list parallel_resnet50 \
#     --print-freq 50 \
#     --freeze_backbone \
#     --model_paths \
#     logs_RSEE/g1029-094724_hmdb_parallel_res50_t16_epo50_multiReso_lr.001/models/ckpt.best.pth.tar \
...
python -u main_base.py ucf101 RGB \
    --irte_joint \
    --arch parallel_resnet50 --num_segments 10 --epochs 50 --batch-size 56 -j 16 \
    --npb --gpus 0 --exp_header BLSTM_ucf101_pres50_t10_3m124_a10e.05_ed5_ft15ds_lr.001_gu3_ep50 \
    --ada_reso_skip --policy_backbone resnet18 --reso_list 224 168 112 84 \
    --backbone_list parallel_resnet50 \
    --print-freq 50 --lr 0.001 --lr_type step --lr_steps 20 40 \
    --freeze_backbone \
    --model_paths \
    ...
    --exp_decay --init_tau 5 --policy_also_backbone --policy_input_offset 3 \
    --accuracy_weight 0.95 --efficency_weight 0.05 \
    --uniform_loss_weight 0.0 --random_seed 1007 --use_gflops_loss \
    --data_dir ../UCF101 --log_dir logs_RSEE \
    --blstm --irte_final --TE 0.99\
    > log_joint.log
